...
import 'package:instagram/view/widgets/divider.dart';
...
class _CommentsPageState extends State<CommentsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    print("commentsdddddd${widget.comments[0].commenter_id}");
                  ...
                  itemBuilder: (context, index) => ListTile(
                    ...
                    title: RichText(
                      text: TextSpan(
                          ...
                          text: "${widget.comments[index].commenter_name}  ",
                          children: [
                            TextSpan(
                                style: TextStyle(
                    ...
                    subtitle: SizedBox(
                      ...
                      child: Wrap(
                        ...
                        children: [
                          ...
                          widget.comments[index].like == 0
                              ? SizedBox()
                              : Padding(
                                  padding: EdgeInsets.only(left: Dimension.pw15),
                                  child: Text(
                                    "${widget.comments[index].like} like",
                                    style: textStyle,
                                  )),
                          Padding(
                            padding:
